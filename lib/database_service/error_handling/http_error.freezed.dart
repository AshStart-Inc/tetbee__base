...
abstract class $HttpErrorCopyWith<$Res> {
  ...
  @useResult
  $Res call({String error, int statusCode, String description});
}
...
abstract class _$$HttpErrorImplCopyWith<$Res>
  ...
  factory _$$HttpErrorImplCopyWith(
    _$HttpErrorImpl value,
    $Res Function(_$HttpErrorImpl) then,
...
class __$$HttpErrorImplCopyWithImpl<$Res>
  ...
  __$$HttpErrorImplCopyWithImpl(
    _$HttpErrorImpl _value,
    $Res Function(_$HttpErrorImpl) _then,
  ) : super(_value, _then);
...
class _$HttpErrorImpl implements _HttpError {
  ...
  @override
  String toString() {
    return 'HttpError(error: $error, statusCode: $statusCode, description: $description)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, error, statusCode, description);
  ...
  Map<String, dynamic> toJson() {
    return _$$HttpErrorImplToJson(this);
  }
}
