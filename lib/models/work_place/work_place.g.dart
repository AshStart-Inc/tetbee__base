...
_$WorkPlaceImpl _$$WorkPlaceImplFromJson(
  ...
  googlePlaceModel: GooglePlaceModel.fromJson(
  ...
  timeZone: TimeZoneModel.fromJson(json['timeZone'] as Map<String, dynamic>),
  ownersIds:
      (json['ownersIds'] as List<dynamic>).map((e) => e as String).toList(),
  joinedUsersOrdinal: Map<String, int>.from(json['joinedUsersOrdinal'] as Map),
  positions:
  ...
  openingTimes:
      (json['openingTimes'] as List<dynamic>)
          .map((e) => WorkPlaceOpeningTime.fromJson(e as Map<String, dynamic>))
          .toList(),
  availabilityReceiverDefaultSetting: AvailabilityReceiverSetting.fromJson(
...
Map<String, dynamic> _$$WorkPlaceImplToJson(_$WorkPlaceImpl instance) =>
    <String, dynamic>{
      ...
      'googlePlaceModel': instance.googlePlaceModel,
      ...
      'availabilityReceiverDefaultSetting':
          instance.availabilityReceiverDefaultSetting,
